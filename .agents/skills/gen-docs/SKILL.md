...
- `docs/scripts/sync-changelog.mjs` — auto-syncs root `CHANGELOG.md` to `docs/en/release-notes/changelog.md` and `CHANGELOG.zh-CN.md` to `docs/zh/release-notes/changelog.md`.
...
3. **Sync changelog to docs**

   Ensure root [CHANGELOG.md](CHANGELOG.md) and [CHANGELOG.zh-CN.md](CHANGELOG.zh-CN.md) are updated and in sync, then run:
...
- **Locale sync**: Non-changelog pages stay mirrored between `docs/en/` and `docs/zh/`. Changelog lives at the repo root: English in `CHANGELOG.md`, Chinese in `CHANGELOG.zh-CN.md`; keep both in sync before running `sync-changelog.mjs`.
...
- **Do not edit auto-synced files**: `docs/en/release-notes/changelog.md` and `docs/zh/release-notes/changelog.md` are regenerated by the sync script; any manual edit will be overwritten.
