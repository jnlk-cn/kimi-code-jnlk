...
完整发行说明见 [CHANGELOG.zh-CN.md](CHANGELOG.zh-CN.md)（英文版：[CHANGELOG.md](CHANGELOG.md)；同步至[文档站](docs/zh/release-notes/changelog.md)）。CLI 包级历史见 [apps/kimi-code/CHANGELOG.md](apps/kimi-code/CHANGELOG.md)。若你只需要官方 Kimi 模型与上游发行渠道，请继续使用上游项目。
