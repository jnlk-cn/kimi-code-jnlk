...
当前发行版本：**0.24.1**（`v0.24.1-jnlk`）。本 fork 会定期同步 upstream，并在其上叠加社区补丁。相对官方 [MoonshotAI/kimi-code](https://github.com/MoonshotAI/kimi-code)：
...
完整变更见 [apps/kimi-code/CHANGELOG.md](apps/kimi-code/CHANGELOG.md)。若你只需要官方 Kimi 模型与上游发行渠道，请继续使用上游项目。
