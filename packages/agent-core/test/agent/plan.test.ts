...
describe('plan allows safe tool flow', () => {
  ...
  it('allows read-only Bash to continue through permission and execution', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "model": "mock-model", "contextTokens": 0, "maxContextTokens": 1000000, "contextUsage": 0, "planMode": true, "swarmMode": false, "askMode": false, "debugMode": false, "interactionMode": "plan", "permission": "yolo" }
